...
class PHPMailer
{
     ...
     *                            For example 'file-min.jpg' would get an 'image/jpeg' MIME type.
     * @param string $encoding    File encoding (see $Encoding), defaults to 'base64'
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/images/a-min.png"> and must not be empty
     * will look for an image file in $basedir/images/a-min.png and convert it to inline.

...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- favicon icon -->
        <link rel="shortcut icon" href="images/PharmaConnect Logo Main.png">
                ...
                <div class="container-fluid">
                    <div class="row h-45px align-items-center m-0">
                        <div class="col-md-6 text-center text-md-start">
                            <div class="fs-14 text-dark-gray">Our consulting experts waiting for you! <a href="contact.html" class="text-base-color fw-500 text-decoration-line-bottom">Contact now</a></div>
                        </div>
                        <div class="col-6 text-end d-none d-md-flex">
                            <div class="widget fs-14 me-30px md-me-0"><a href="tel:+27 735222928" class="text-dark-gray"><i class="feather icon-feather-phone-call text-base-color"></i> +27 735222928</a></div>
                            <div class="widget fs-14 text-dark-gray d-none d-lg-inline-block"><i class="feather icon-feather-mail text-base-color"></i> info@pharmaconnect.co.za</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="col-auto col-lg-2 me-auto">
                        <a class="navbar-brand" href="index.html">
                            <img src="images/PharmaConnect Logo Main.png" data-at2x="images/demo-consulting-logo-white@2x.png" alt="" class="default-logo">
                            <img src="images/PharmaConnect Logo Main.png" data-at2x="images/demo-consulting-logo-black@2x.png" alt="" class="alt-logo">
                            <img src="images/PharmaConnect Logo Main.png" data-at2x="images/demo-consulting-logo-black@2x.png" alt="" class="mobile-logo">
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav alt-font">
                                ...
                                <li class="nav-item dropdown simple-dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <li><a href="demo-consulting-services-details.html">Pharmaconnect 2017</a></li>
                                        <li><a href="demo-consulting-services-details.html">Pharmaconnect 2018</a></li>
                                        <li><a href="demo-consulting-services-details.html">Pharmaconnect 2019</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center pt-7 sm-pt-50px">
                    ...
                    <div class="col-7 col-lg-3 col-md-12 col-sm-6 text-md-center text-lg-start md-mb-30px">
                        <a href="index.html" class="footer-logo mb-15px md-mb-20px d-inline-block"><img src="images/PharmaConnect Logo Main.png" data-at2x="images/demo-consulting-logo-black@2x.png" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 xs-mb-30px">
                        <span class="alt-font d-block text-dark-gray fw-600 mb-10px fs-19">Get in touch</span>
                                                <p class="m-0"><span class="fw-600"><i class="feather icon-feather-phone-call text-dark-gray icon-small me-10px"></i></span><a href="tel:1800222000">+27 735222928</a></p>
                        <p class="m-0"><span class="fw-600"><i class="feather icon-feather-mail text-dark-gray icon-small me-10px"></i></span><a href="mailto:info@domain.com">info@pharmaconnect.co.za</a></p>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->

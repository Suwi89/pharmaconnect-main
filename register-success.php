...
<html class="no-js" lang="en">
    <head>
        ...
        <meta name="description" content="Pharmaconnect Africa">
        <!-- favicon icon -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7 text-center mb-2" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                        <span class="fw-600 ls-1px fs-20 alt-font d-inline-block text-uppercase mb-5px text-base-color">Thank you for registering for PharmaConnect Africa Conference 2024 !</span>
                ...
                <div class="row row-cols-md-1 justify-content-center" data-anime='{ "translateY": [100, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                   <p class="justify-p">
                        We are delighted to have you join us in Lusaka for this exciting event. Please note that your registration is currently pending and will not be confirmed until we receive your payment.
                   </p>
                   ...
                   <p class="justify-p">
                        We look forward to your participation and are excited to welcome you to what promises to be a memorable and enriching experience!

                        For more information on payment methods or if you have any questions, please do not hesitate to contact us.
                   </p>

                   <p>
                     Best regards, <br /> 
                     The PharmaConnect Africa Conference 2024 Team
                   </p>
                ...
                <div class="row justify-content-center pt-7 sm-pt-50px">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 xs-mb-30px">
                        <span class="alt-font d-block text-dark-gray fw-600 mb-10px fs-19">Get in touch</span>
                                                <p class="m-0"><span class="fw-600"><i class="feather icon-feather-phone-call text-dark-gray icon-small me-10px"></i></span><a href="tel:+260 97 3886276">+260 97 3886276</a></p>
                        <p class="m-0"><span class="fw-600"><i class="feather icon-feather-mail text-dark-gray icon-small me-10px"></i></span><a href="mailto:info@pharmaconnectafrica.com">info@pharmaconnectafrica.com</a></p>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
